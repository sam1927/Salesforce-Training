<div id="retro-homepage" class="theme-level-home">
  ...
  <div id="retro-main" class="retro-main-content" style="display: none;">
    ...
    <div class="retro-logo-wrap">
      <img
        class="retro-logo-image"
        src="assets/images/branding/bootstrap-logo.png"
        alt="MindJam logo"
      >
    </div>
  ...
  <div id="retro-reveal" class="retro-reveal" aria-hidden="true">
    <div class="retro-reveal__flash"></div>
    <div class="retro-reveal__line"></div>
    <div class="retro-reveal__text">System Ready</div>
  </div>
